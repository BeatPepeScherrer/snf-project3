...
from utils.prompts import relational_contracting_narrative_extraction
...
PROMPT = ChatPromptTemplate.from_template(relational_contracting_narrative_extraction)
...
if __name__ == "__main__":
    ...
    for doc_id, response in tqdm(zip(doc_ids, response_texts), total=len(doc_ids)):
        prompt = relational_contracting_narrative_extraction + f'\n\nDocument ID: {doc_id}\n\nResponse:\n{response}'
